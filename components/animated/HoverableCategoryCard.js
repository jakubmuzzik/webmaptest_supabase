...
const HoverableCategoryCard = ({ selected, imagePath, categoryName, contentWidth, onCategoryPress }) => {
    ...
    return (
        ...
        >
            ...
            <View style={{ flexDirection: 'column', justifyContent: 'flex-end', alignItems: 'center', flex: 1, marginTop: -SPACING.medium }}>
                <Text style={{ transitionDuration: '250ms', opacity: (isHovered || selected) ? '1' : '0', color: COLORS.white, fontFamily: FONTS.bold, fontSize: FONT_SIZES.large, textAlign: 'center' }}>
                    {categoryName}
                </Text>
            </View>
        </TouchableOpacity>
